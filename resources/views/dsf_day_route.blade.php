...
<html>
  <head>
    ...
    <title>DSF Day Route - {{$brcode}} - {{$dsfcode}}</title>
...
/*#map.fullscreen {
  ...
  <body>
    <div class="container-fluid example-screen">
        <input type="hidden" value="{{$countdsfroute}}" id="countdsfroute" name="countdsfroute">
        <input type="hidden" value="{{$dsfcode}}" id="dsfcode" name="dsfcode">
        <input type="hidden" value="{{$brcode}}" id="brcode" name="brcode">
        <input type="hidden" value="{{$branchname}}" id="branchname" name="branchname">
        <input type="hidden" value="{{$bdate}}" id="bdate" name="bdate">
        <input type="hidden" value="{{$str_lat}}" id="str_lat" name="str_lat">
        <input type="hidden" value="{{$str_lng}}" id="str_lng" name="str_lng">
        <input type="hidden" value="{{$end_lat}}" id="end_lat" name="end_lat">
        <input type="hidden" value="{{$end_lng}}" id="end_lng" name="end_lng">
        <input type="hidden" value="{{$bookingamount}}" id="bookingamount" name="bookingamount">
        <input type="hidden" value="{{$productivecustomer}}" id="productivecustomer" name="productivecustomer">
      ...
      <div class="row">
        ...
        <!--   <b>Start:</b>
          ...
          <h4 style="margin-top:10px;tex-align:center;text-decoration:underline;display:inline-block">DSF Route Journey</h4>

          <div class="panel panel-green" style="background-color:#fffff !important;margin-top:15px">
            
            <a >
                <div class="panel-footer">
                    <span class="pull-left green">Branch Name<br>{{$brcode}} - {{$branchname}}</span>
        ...
        <div class="panel panel-green" style="background-color:#fffff !important;margin-top:15px">
            ...
            <a >
                <div class="panel-footer">
                    <span class="pull-left green">DSF Name<br> {{$dsfcode}} - {{$dsfname}}</span>
                    <span class="pull-right green"><i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
                </div>
            </a>
         ...
         <div class="panel panel-green" style="background-color:#fffff !important;margin-top:15px">
            ...
            <a >
                <div class="panel-footer">
                    <span class="pull-left green">Booking Date<br> {{date("d-M-Y", strtotime($bdate))}}</span>
                    <span class="pull-right green"><i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
                </div>
            </a>
         ...
         <div class="panel panel-green" style="background-color:#fffff !important;margin-top:15px">
            ...
            <a >
                <div class="panel-footer">
                    <span class="pull-left green">Total Booking Amount<br>{{number_format($bookingamount)}}</span>
                    <span class="pull-right green"><i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
                </div>
            </a>
         ...
         <div class="panel panel-green" style="background-color:#fffff !important;margin-top:15px">
            ...
            <a >
                <div class="panel-footer">
                    <span class="pull-left green">Productive Customers<br>{{$productivecustomer}} / {{$overallcustomer}}
                   <?php 
                   if($overallcustomer == 0 || $overallcustomer == ""){$overallcustomer=1;}
                  $percentage=($productivecustomer * 100) / $overallcustomer;
        ...
        <div class="panel panel-green" style="background-color:#fffff !important;margin-top:15px">
         ...
         <!-- <div class="panel panel-green" style="background-color:#fffff !important;margin-top:15px">
            ...
            <a >
                <div class="panel-footer">
                    <span class="pull-left green">Total Travelling Distance<br><span id="totaltravellingdistance"></span> Km</span>
                    <span class="pull-right green"><i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
                </div>
            </a>
         ...
         <!-- <div class="panel panel-green" style="background-color:#fffff !important;margin-top:15px">
            ...
            <a >
                <div class="panel-footer">
                    <span class="pull-left green">Total Travelling Time<br><span id="totaltravellingtime"></span> Minutes</span>
                    <span class="pull-right green"><i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
                </div>
            </a>
...
//     .catch(error => console.error('Error fetching markers:', error));
  ...
  var branchname=$('#branchname').val() + "Branch";
...
function calculateAndDisplayRoute(directionsService, directionsRenderer) {
  ...
  $.ajax({
            type:"POST",
            url: "{{ url('getdsfdailyroute') }}",
            data: { dsfcode: dsfcode,brcode:brcode,bdate:bdate},
            dataType: 'json',
 ...
 var str_lat=document.getElementById("str_lat").value;
 var str_lng=document.getElementById("str_lng").value;
 var end_lat=document.getElementById("end_lat").value;
 var end_lng=document.getElementById("end_lng").value;
