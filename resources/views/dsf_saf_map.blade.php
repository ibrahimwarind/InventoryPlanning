...
<html>
  <head>
    ...
    <title>DSF SAF In MAP  - {{$brcode}} - {{$dsfcode}}</title>
    ...
    <div class="container-fluid example-screen">
      ...
      <div class="row">
        ...
        <!--   <b>Start:</b>
          ...
          <h4 style="margin-top:10px;tex-align:center;text-decoration:underline;display:inline-block">DSF SAF Detail</h4>
        ...
        <div class="panel panel-green" style="background-color:#fffff !important;margin-top:15px">
         ...
         <div class="panel panel-green" style="background-color:#fffff !important;margin-top:15px">
            ...
            <a >
                <div class="panel-footer">
                    <span class="pull-left green">Productive Customers<br>{{$productivecustomer}}
        ...
        <div class="panel panel-green" style="background-color:#fffff !important;margin-top:15px">
            ...
            <a >
                <div class="panel-footer">
                    <span class="pull-left green">Non Productive Customers<br>{{$overallcustomer - $productivecustomer}}
        ...
        <div class="panel panel-green" style="background-color:#fffff !important;margin-top:15px">
            ...
            <a >
                <div class="panel-footer">
                    <span class="pull-left green">Productive %<br>
                    <?php 
