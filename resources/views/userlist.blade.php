				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3" style="margin-top: -20px">
					...
					<div class="ms-auto">
						<div class="btn-group">
							...
							<button type="button" class="btn btn-primary" style="padding:2px !important;font-size:15px;height:30px">Total User : {{number_format($totaluser)}}</button>
							...
							<table id="example" class="table table-striped table-bordered" >
								...
								<tbody>
									...
									<tr>
										...
										<td><center>{{$branch_count}} Branch's</center></td>
										<td style="width:60px !important">
											<center>
											<a href="<?php echo PROJECTURL ?>/assignrole/{{$user->admin_id}}"  target="_blank" style='display: inline-block;'> 
												<i class="fa fa-list" aria-hidden="true"></i>
											</a>
											
												&nbsp;&nbsp;
											<a href="<?php echo PROJECTURL ?>/edituser/{{$user->admin_id}}"  target="_blank" style='display: inline-block;'>
