		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3" style="margin-top: -20px">
					<span style="color:black;font-size: 18px">&nbsp;&nbsp; (Business Line Wise Product List)</span> &nbsp;&nbsp;&nbsp;&nbsp;
					<span style="color:black;font-size: 16px;text-decoration: unde">&nbsp;&nbsp;Branch : {{$branchname}}</span> &nbsp;&nbsp;|&nbsp;&nbsp; 
					<span style="color:black;font-size: 16px">&nbsp;&nbsp;Group : {{$groupname}}</span>&nbsp;&nbsp;|&nbsp;&nbsp;
					<span style="color:black;font-size: 16px">&nbsp;&nbsp;Company : {{$companyname}}</span>
					...
					<div class="ms-auto">
						<div class="btn-group">
							...
							<button type="button" class="btn btn-primary" style="padding:2px !important;font-size:15px;height:30px">Total Products : {{number_format($businessproductdatacount)}}</button>
					...
					<div class="card-body">
						<div class="">
							<table id="example" class="table table-striped table-bordered" >
								...
								<tbody>
									@foreach($businessproductdata as $user)
									
									<tr>
								<td style="text-align: center;font-size:13px">{{$user->company_code}} - {{$companyname}}</td>
