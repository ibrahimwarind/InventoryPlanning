@include('header')
<?php 
$con=mysqli_connect("127.0.0.1",DATABASEUSER,DATABASEPASS,DATABASENAME);
?>
		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<h6 class="mb-0 text-uppercase">
					<form method="get" action="<?php echo PROJECTURL ?>/addmustsellingproduct2">
						@csrf
					<div class="row">
						
						<div class="col-sm-4 col-6"  style="">
							<select class="form-control" style="" required name="pro_branch" id="pro_branch" >
