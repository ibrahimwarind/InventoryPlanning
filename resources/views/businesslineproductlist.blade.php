		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3" style="margin-top: -20px">
					<div class="breadcrumb-title pe-3">Business Line Product List</div>
					
					<div class="ms-auto">
						<div class="btn-group">
							
							<button type="button" class="btn btn-primary" style="padding:2px !important;font-size:15px;height:30px">Total Business Line Product : {{number_format($totalbusinesslineproduct)}}</button>
				...
				<h6 class="mb-0 text-uppercase">
					<form method="get" action="<?php echo PROJECTURL ?>/businesslineproduct2">
						@csrf
					<div class="row">
						...
						<div class="col-sm-2  col-12">
							...
							<a href="<?php echo PROJECTURL ?>/businesslineproduct" class="btn btn-primary" style="padding:2px !important;font-size:15px;height:30px">Clear</a>
						</div>
					</div>
				   </form>
				</h6>
...
<!-- 				status , proname id code , brand , company  -->
					...
					<div class="card-body">
						<div class="">
							<table id="example" class="table table-striped table-bordered" >
								...
								<tbody>
									@foreach($businesslinedataproduct as $user)
									<?php 
            $brname="";
            ...
            $compname="";
            $fg_br="SELECT product_name FROM `sb_products` where product_code='$user->product_code'";
            $run_br=mysqli_query($con,$fg_br);
            if(mysqli_num_rows($run_br) !=0)
            {
            	$row_br=mysqli_fetch_array($run_br);
            	$compname=$row_br['product_name'];
            }
									?>
									<tr>
								...
								<td style="">{{$user->product_code}} - {{$compname}}</td>
