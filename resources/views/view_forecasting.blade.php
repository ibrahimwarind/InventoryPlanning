...
?>
   <input type="hidden" id="csrf_token" value="{{csrf_token()}}">
		...
		<div class="page-wrapper">
            ...
            <span style="float: right !important"><a href="/printforecasting/{{$fid}}/{{$key}}/{{$sort}}" target="_blank" class="text-danger"><i class="fa-solid fa-print" style="font-size:28px"></i></a>
              || <a href="/exportforcasting/{{$fid}}/{{$key}}/{{$sort}}" class="text-success"><i class="fas fa-file-excel" style="font-size:28px"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;</span>
            </h6>
   ...
   <br>
                    <table border="1" style="width:100%" class="forecastingTable">
                      ...
                      <tr style="background-color: #398E3D;color:white;border: 1px solid black;font-size:12px">
                          ...
                          <td style="border: 1px solid white"><center>Final<br>Plan (Carton)</center></td>
              ...
              <tr style='border:1px solid black;font-size:12px'>
                ...
                <td style='border:1px solid black;color:white;text-align:center;background-color: #398E3D'>".number_format($pr_diff)."</td>
                ...
                <td style='border:1px solid black;color:white;text-align:center;background-color: #398E3D'>".number_format($final_planoutput)."</td>
                <td style='border:1px solid black;color:white;text-align:center;background-color: #398E3D'>".number_format($final_output_value)."</td>
                <td style='border:1px solid black;color:white;text-align:center;background-color: #398E3D'>".number_format($final_output_packingsize)."</td>
   ...
   <br>
                    <table border="1" style="width:100%" class="forecastingTable">
                      ...
                      <tr style="background-color: lightgray;color:black;">
                          <th colspan="20" style="padding:10px;border: 1px solid black">{{$mst->product_code}} - {{$mst->product_name}}</th>
                        </tr>
                      <tr style="background-color: #398E3D;color:white;border: 1px solid black;font-size:12px">

                          <td style="border: 1px solid white"><center>Branch Name</center></td>
                           <td style="border: 1px solid white"><center>CTN<br>Size</center></td>
                          <td style="border: 1px solid white"><center id="monthname1">{{date("M", strtotime($sale_month1))}} Sales</center></td>
                          <td style="border: 1px solid white"><center id="monthname2">{{date("M", strtotime($sale_month2))}} Sales</center></td>
                          <td style="border: 1px solid white"><center id="monthname3">{{date("M", strtotime($sale_month3))}} Sales</center></td>
              ...
              <tr style='border:1px solid black;font-size:13px'>
                <td style='border:1px solid black;color:black'>$branch_row_id - $brnames</td>
                <td style='border:1px solid black;color:black;text-align:center'>$packing_size</td>
                <td style='border:1px solid black;color:black;text-align:center'>".number_format($sale_qty1)."</td>
                <td style='border:1px solid black;color:black;text-align:center'>".number_format($sale_qty2)."</td>
                <td style='border:1px solid black;color:black;text-align:center'>".number_format($sale_qty3)."</td>
  ...
  @endif
									...
									<div class="col-12">
<br><br>
<a style="background-color: #398E3D;color:white" href="/forecastinglist" class="btn btn-primary" >
<- Back to List
</a>
