		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3" style="margin-top: -20px">
					<div class="breadcrumb-title pe-3">DSF Business Line List</div>
					
					<div class="ms-auto">
						<div class="btn-group">
							
							<button type="button" class="btn btn-primary" style="padding:2px !important;font-size:15px;height:30px">Total DSF Business Line : {{number_format($totaldsfbline)}}</button>
				...
				<h6 class="mb-0 text-uppercase">
					<form method="get" action="<?php echo PROJECTURL ?>/dsfbusinessline2">
						@csrf
					<div class="row">
						...
						<div class="col-sm-2  col-12">
							...
							<a href="<?php echo PROJECTURL ?>/dsfbusinessline" class="btn btn-primary" style="padding:2px !important;font-size:15px;height:30px">Clear</a>
						</div>
					</div>
				   </form>
				</h6>
					...
					<div class="card-body">
						<div class="">
							<table id="example" class="table table-striped table-bordered" >
								...
								<tbody>
									@foreach($dsfblinedata as $user)
									
									<tr>
								<td style="font-size:12px">{{$user->branch_code}} - {{$user->branch_name}}</td>
								<td style="font-size:12px">{{$user->supply_groupid}} - {{$user->supply_groupname}}</td>
								<td style="font-size:12px">{{$user->dsf_code}} - {{$user->dsf_name}}</td>	
								
								<td style="text-align: center;font-size:12px">{{$user->dsf_cnic}} </td>
